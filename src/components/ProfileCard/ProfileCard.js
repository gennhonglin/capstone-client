...
function ProfileCard() {
    ...
    if (token === 'guest' || token === null) {
        ...
        display = <div className="profile-card">
            <div className="profile-card__container">
                <div className="profile-card__container__header">
                    <div className="profile-card__container__header__profile">
                        <img className="profile-card__container__header__profile-img" alt="placeholder img" src={placeholder} />
                    </div>
                    <div className="profile-card__container__header__content">
                        <h1 className="profile-card__container__header__content-name">{checkDataNull(selectedUser.name)}</h1>
                        <h2 className="profile-card__container__header__content-team">{checkDataNull(selectedUser.type)}</h2>
                    </div>
                    <div className="profile-card__container__header__edit">
                        <Link to={'/edit-profile'}>
                            <svg className="profile-card__container__header__edit-img" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="profile-card__container__body">
                    <div className="profile-card__container__body-information">
                        <h2 className="profile-card__container__body-information-title">City :</h2>
                        <h3 className="profile-card__container__body-information-data">{checkDataNull(selectedUser.city)}</h3>
                    </div>
                    <div className="profile-card__container__body-information">
                        <h2 className="profile-card__container__body-information-title">Country :</h2>
                        <h3 className="profile-card__container__body-information-data">{checkDataNull(selectedUser.country)}</h3>
                    </div>
                    <div className="profile-card__container__body-information">
                        <h2 className="profile-card__container__body-information-title">Experience :</h2>
                        <h3 className="profile-card__container__body-information-data">{checkDataNull(selectedUser.experience)}</h3>
                    </div>
                    <div className="profile-card__container__body-information">
                        <h2 className="profile-card__container__body-information-title">Position :</h2>
                        <h3 className="profile-card__container__body-information-data">{checkDataNull(selectedUser.position)}</h3>
                    </div>
                    <div className="profile-card__container__body-information">
                        <h2 className="profile-card__container__body-information-title">Email :</h2>
                        <h3 className="profile-card__container__body-information-data">{checkDataNull(selectedUser.email)}</h3>
                    </div>
                </div>
            </div>
        </div>
